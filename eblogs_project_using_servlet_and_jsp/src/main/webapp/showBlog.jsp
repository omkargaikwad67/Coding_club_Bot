...
<%@ page import="com.user.Post" language="java"
	...
	<div class="row">
		<div class="col-md-12">
			...
			if (user3 != null) {
				...
				java.util.List<Post> post = PostDAO.getData(user3.getId());
				...
				<div class="card-body p-4">
					...
					<div class="container text-center mt-2">
						<a href="deleteServlet?note_id=<%=po.getId()%>"
							...
							class="fa-solid fa-trash-can-arrow-up"></i>Delete</a> <a
							href="edit.jsp?note_id=<%=po.getId()%>" class="btn btn-primary"><i
							class="fa-regular fa-pen-to-square" aria-hidden="true"></i>Edit</a>
